...
const colors = ["rgba(255,0,255,1)", "rgba(0,255,0,1)", "rgba(255,255,0,1)"]
! function (a, b) {
  "use strict";
  ...
  function d(d, g) {
    ...
    return g = c({}, a[e].defaults, g), n.prototype.draw = function () {
      s.beginPath(), s.arc(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY, g.particleRadius /2, 0, 2 * Math.PI, !0), s.fill(), s.beginPath();
      for (var a = z.length - 1; a > this.stackPos; a--) {
        var b = z[a],
          ...
          if(e<g.proximity) {
            ...
            s.lineTo(b.position.x + b.parallaxOffsetX + g.proximity + 100, b.position.y + b.parallaxOffsetY);
            s.closePath();
            s.fill()
          }
        // e < g.proximity && (s.moveTo(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY), s.lineTo(b.position.x + b.parallaxOffsetX, b.position.y + b.parallaxOffsetY), s.lineTo(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY))
      }
...
particleground(document.getElementById('particles-foreground'), {
  ...
  curvedLines: false,
  proximity: 0, // How close two dots need to be before they join
  parallaxMultiplier: 500000, // Lower the number is more extreme parallax
...
particleground(document.getElementById('particles-background'), {
  ...
  curvedLines: false,
  proximity: 0, // How close two dots need to be before they join
  parallaxMultiplier: 1000000, // Lower the number is more extreme parallax
  particleRadius: 3, // Dot size
});

particleground(document.getElementById('particles-triground'), {
  dotColor: colors[2],
  ...
  curvedLines: false,
  proximity: 0, // How close two dots need to be before they join
  parallaxMultiplier: 200000, // Lower the number is more extreme parallax
  particleRadius: 3, // Dot size
});
